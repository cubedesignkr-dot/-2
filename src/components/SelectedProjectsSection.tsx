  ...
  const featuredProjects = [
    {
      ...
      description: '대규모 디지털 사이니지 및 미디어타워 환경의 콘텐츠 송출과 통합관제를 안정적으로 운영합니다.',
    ...
    },
    {
      ...
      description: '대형 메인 LED 미디어 큐브 및 난간 디스플레이 등 대규모 공연 미디어 환경을 구축 운영합니다.',
    ...
    },
    {
      ...
      description: '도심 상업 복합공간 외벽의 대형 곡면 LED 파사드를 구축 및 통합 제어합니다.',
    ...
    },
    {
      ...
      description: '금융 중심지 여의도 IFC몰 아트리움 미디어타워의 콘텐츠 송출과 운영을 담당합니다.',
