  ...
  return (
    <section className="py-20 sm:py-28 bg-[#F5F6F7] text-[#222831] border-b border-[#D9DEE3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border-t border-b border-[#D9DEE3] divide-y md:divide-y-0 md:divide-x divide-[#D9DEE3]">
          {/* Solution 01 */}
          <div className="py-8 md:py-10 md:px-8 first:md:pl-0 last:md:pr-0 flex flex-col justify-between">
            <div>
              <div className="text-xs font-mono font-semibold text-[#294A63] uppercase tracking-widest mb-3">
                01 — LED MEDIA
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-[#222831] tracking-tight mb-2">
                LED Media Planning &amp; Installation
              </h3>
              <p className="text-xs sm:text-sm text-[#66717C] leading-[1.7] font-normal">
        ...
        {/* Simplified Horizontal Process Line */}
        <div className="mt-10 pt-6 border-t border-[#D9DEE3]">
          <div className="text-[11px] font-mono font-semibold text-[#66717C] uppercase tracking-widest mb-3">
            INTEGRATED EXECUTION PROCESS
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs font-mono font-semibold text-[#222831] tracking-wider">
            <span className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#66717C]"></span>
              PLANNING
            </span>
            <span className="hidden sm:inline text-[#D9DEE3]">→</span>
            <span className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#66717C]"></span>
              DESIGN &amp; INSTALLATION
            </span>
